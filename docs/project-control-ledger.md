...
Timestamp: `2026-05-27 01:59:02 +08:00`.

- Active branch: `main`.
- Latest recorded `main` commit: `d293fe8 Record asset source binding badge merge`.
- Latest product code commit: `ac6b649 Clarify asset source binding status`.
...
- Optional demo/test data slice: add a stable fixture for "selected record ready but package/batch still blocked" so final-lock copy can be browser-verified.
