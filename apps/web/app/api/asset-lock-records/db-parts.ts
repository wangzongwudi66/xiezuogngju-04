...
export type AssetLockRecordDbRecordInsert = typeof assetLockRecords.$inferInsert;
export type AssetLockRecordDbEpisodeInsert = typeof assetLockRecordEpisodes.$inferInsert;
export type ScriptSourceBindingDbInsert = typeof scriptSourceBindings.$inferInsert;

export interface DbAssetLockRecordParts {
  assetLockRecords: AssetLockRecord[];
  scriptSourceBindings: ScriptSourceBinding[];
}

export async function readDbAssetLockRecordParts(): Promise<DbAssetLockRecordParts> {
  ...
  return {
    assetLockRecords: mapAssetLockRecordRows(recordRows, episodeRows),
    scriptSourceBindings: mapScriptSourceBindingRows(sourceBindingRows)
  };
}
...
export type AssetLockRecordDbRecordUpdate = Pick<
